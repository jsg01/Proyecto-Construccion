...
class PlaneTransformServer(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter(
            "plane_yaml",
            os.path.expanduser(
                "/home/ricardo/Desktop/LabRobot/Paula/src/config/plane_calibration.yaml"
            ),
        )
    ...
    def handle_pixel_to_robot(self, request, response):
        #self.get_logger().info("PIXEL TO ROBOT SERVICE")
        try:
        ...
        #self.get_logger().info("I FINISHED THE SERVICE")
        return response
