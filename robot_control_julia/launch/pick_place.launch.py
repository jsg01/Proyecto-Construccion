...
def launch_setup(context, *args, **kwargs):
    x_pick = LaunchConfiguration("x_pick")
    y_pick = LaunchConfiguration("y_pick")
    z_pick = LaunchConfiguration("z_pick")
    x_place = LaunchConfiguration("x_place")
    y_place = LaunchConfiguration("y_place")
    z_place = LaunchConfiguration("z_place")
    ...
    node = Node(
        ...
        output="screen",
        arguments=[x_pick, y_pick, z_pick, x_place, y_place, z_place],
        parameters=[
            robot_description,
            robot_description_semantic,
...
def generate_launch_description():
    args = [
        DeclareLaunchArgument("x_pick"),
        DeclareLaunchArgument("y_pick"),
        DeclareLaunchArgument("z_pick"),
        DeclareLaunchArgument("x_place"),
        DeclareLaunchArgument("y_place"),
        DeclareLaunchArgument("z_place"),
