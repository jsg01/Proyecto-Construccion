...
class PieceDetectionPublisher(Node):
    def __init__(self):
        super().__init__('piece_detection_publisher')
        ...
        self.mask_pub = self.create_publisher(Image, '/piece_mask', 10)
        self.debug_pub = self.create_publisher(Image, '/piece_debug', 10)
    ...
    def image_callback(self, msg: Image) -> None:
        ...
        self.debug_pub.publish(annotated_msg)
        ...
        if len(detections) > 0:
            self.get_logger().info(f'{len(detections)} piezas detectadas')
